...
class SurvivorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post survivors_url, params: { survivor: { abducted: @survivor.abducted, age: @survivor.age, gender: @survivor.gender, latitude: @survivor.latitude, longitude: @survivor.longitude, name: @survivor.name } }
    end
  ...
  test "should update survivor" do
    patch survivor_url(@survivor), params: { survivor: { abducted: @survivor.abducted, age: @survivor.age, gender: @survivor.gender, latitude: @survivor.latitude, longitude: @survivor.longitude, name: @survivor.name } }
